...
# ---------------------------------------------------------
# સિલેબસ ડેટાબેઝ (ધોરણ 5 અને 6 ના તમામ વિષયો)
# ---------------------------------------------------------
syllabus = {
    5: [
...
# નવો કડક પ્રોમ્પ્ટ (વિષય મિક્સ ન થવા દેવા માટે)
prompt = f"""
...
અત્યંત કડક નિયમો (STRICT QUALITY CONTROL & ISOLATION):
1. વિષયની શુદ્ધતા (NO MIXING): આ પ્રશ્નો માત્ર અને માત્ર વિષય '{current_subject['guj_name']}' ના પ્રકરણ {ch_num} માંથી જ હોવા જોઈએ. ભૂલથી પણ બીજા કોઈ વિષય કે બીજા પ્રકરણના પ્રશ્નો મિક્સ ન થવા જોઈએ. આ લોખંડી નિયમ છે.
2. પ્રશ્નોની સંખ્યા (TARGET): ઓછામાં ઓછા {current_q_type['min_count']} પ્રશ્નો ફરજિયાત બનાવવાના છે. જો આ પ્રકરણ મોટું હોય તો {current_q_type['min_count']} થી વધુ પ્રશ્નો બનાવવાની પૂરી કોશિશ કરવી.
3. પ્રકાર મુજબ શરત: {type_specific_rules}
4. નો-રીપીટેશન અને એક્ઝેક્ટ લેવલ: {current_q_type['marks']} ગુણના પ્રશ્નોનું લેવલ બરાબર તેટલા જ માર્કસનું હોવું જોઈએ. પ્રશ્નો એકબીજામાં રીપીટ ન થવા જોઈએ.
